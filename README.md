...
5. Ensure that you correctly link the $\texttt{htool.hpp}$ $\texttt{c++}$ header library and the MPI folder in your $\texttt{Makevars}$ file. So, for the $\texttt{Makevars.win}$:
</br>
